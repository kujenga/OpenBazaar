...
if (MODE == "production"):
    ...
    demo_node_1 = os.spawnlp(os.P_NOWAIT, 'python2', 'python2', './node/tornadoloop.py',
                             STOREFILE, DEMO_IP_PRE+str(1),
                             "--my_node_port="+str(DEMO_NODE_PORT), "--my_node_file="+MY_NODE_FILE, "--log_file="+LOGDIR+"/demo_node%d.log"%1, "--userid=%d"%1)
    ...
    for num in range(2,5):
        ...
        demo_nodes[num] = os.spawnlp(os.P_NOWAIT, 'python2', 'python2', './node/tornadoloop.py',
                                 demo_storefiles[num], DEMO_IP_PRE + str(num),

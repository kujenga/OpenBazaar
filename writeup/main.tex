...
Fourth, Kademlia features bidirectional routing, as opposed to unidirectional routing.
This is a natural consequence of using \emph{bitwise exclusive or} (XOR) as its distance function: that is, $\delta(x,y) = x \oplus y$.
XOR bears the property of symmetry: $\delta(x,y) = \delta(y,x)$.
This means that you may query those you know about, and those you know about may query you.
% TODO why does symmetry let you perform asynchronous queries?
